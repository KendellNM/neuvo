...
class ProductoEsencialAdapter(
    private val onProductoClick: (ProductoDTO) -> Unit,
    private val onAgregarClick: (ProductoDTO) -> Unit
) : ListAdapter<ProductoDTO, ProductoEsencialAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_producto_esencial, parent, false)
    ...
    class ViewHolder(
        ...
        fun bind(producto: ProductoDTO) {
            ...
            if (!producto.imagen_url.isNullOrEmpty()) {
                ...
                imgProducto.setColorFilter(itemView.context.getColor(R.color.secondary))
            }
